...
const forecast = (latitude, longitude, callback) => {
    const url = 'http://api.weatherstack.com/current?access_key=06848f559c309b95c79f3db43e721137&query=' + encodeURIComponent(latitude) + ',' + encodeURIComponent(longitude)
